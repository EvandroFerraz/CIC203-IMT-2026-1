public class TesteMaxHeap {
    ...
    public static void main(String[] args) {
        ...
        // ao inserir em um MaxHeap, a propriedade de max-heap ja e
        // mantida automaticamente (via subirHeap), entao a cada insercao
        // o vetor ja e um max-heap valido.
        for (int v : vs)
            h.inserir(v);
